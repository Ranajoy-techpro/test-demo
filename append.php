<?php
	...
	if(isset($_POST['add']))
	{
		...
		{
			echo "<script type='text/javascript'>alert('Plz input all field');location = 'product_index.php';</script>";
		}
		...
		if (move_uploaded_file($temp_name,$path_filename_ext)) 
		{
			...
			{
				echo "<script type='text/javascript'>alert('Error found');location = 'product_index.php';</script>". $append .$con->error;
			}
		}
	}
	$con->close();
